...
public class Dialogos1Vez : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        dialogos.Add("Dialogo2", "Empecemos, como habrás notado puedes moverte utilizando las teclas A, D, S y W. Manten shift para correr y presiona espacio para saltar_");
